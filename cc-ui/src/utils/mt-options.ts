...
export const industryOptions = [
  {
    ...
    displayValue: 'Rakentaminen ja purkaminen',
    order: 10,
    configurationType: 'IndustryType',
  },
  {
    id: 'jate_vesi_ja_jatevesihuolto',
    displayValue: 'jäte-, vesi- ja jätevesihuolto',
    order: 20,
    configurationType: 'IndustryType',
  },
  {
    id: 'kaivannaisteollisuus',
    displayValue: 'kaivannaisteollisuus',
    order: 30,
    configurationType: 'IndustryType',
  },
  {
    id: 'elintarviketeollisuus',
    displayValue: 'elintarviketeollisuus',
    order: 35,
    configurationType: 'IndustryType',
  },
  {
    id: 'maa_metsa_ja_kalatalous',
    displayValue: 'maa-, metsä, ja kalatalous',
    order: 40,
    configurationType: 'IndustryType',
  },
  {
    id: 'puu_paperi_ja_kartonkiteollisuus',
    displayValue: 'puu-, paperi- ja kartonkiteollisuus',
    order: 50,
    configurationType: 'IndustryType',
  },
  {
    id: 'nahka_turkis_ja_tekstiiliteollisuus',
    displayValue: 'nahka-, turkis- ja teksitiiliteollisuus',
    order: 60,
    configurationType: 'IndustryType',
  },
  {
    id: 'petrokemianteollisuus',
    displayValue: 'petrokemianteollisuus',
    order: 70,
    configurationType: 'IndustryType',
  },
  {
    id: 'kemianteollisuus',
    displayValue: 'kemianteollisuus',
    order: 80,
    configurationType: 'IndustryType',
  },
  {
    id: 'valokuvateollisuus',
    displayValue: 'valokuvateollisuus',
    order: 85,
    configurationType: 'IndustryType',
  },
  {
    id: 'metalliteollisuus',
    displayValue: 'metalliteollisuus',
    order: 90,
    configurationType: 'IndustryType',
  },
  {
    id: 'energiantuotanto',
    displayValue: 'energiantuotanto',
    order: 100,
    configurationType: 'IndustryType',
  },
  {
    id: 'muu_teollisuus',
    displayValue: 'muu teollisuus',
    order: 110,
    configurationType: 'IndustryType',
  },
  {
    id: 'tukku_ja_vahittaiskauppa',
    displayValue: 'tukku- ja vähittäiskauppa',
    order: 120,
    configurationType: 'IndustryType',
  },
  {
    id: 'ravitsemus_ja_majoituspalvelut',
    displayValue: 'ravitsemus- ja majoituspalvelut',
    order: 130,
    configurationType: 'IndustryType',
  },
  {
    id: 'terveydenhuolto',
    displayValue: 'terveydenhuolto',
    order: 140,
    configurationType: 'IndustryType',
  },
  {
    id: 'kotitaloudet_toimistot_koulut_paivakodit_ja_vastaavat',
    displayValue: 'kotitaloudet toimistot koulut paivakodit ja vastaavat',
    order: 150,
    configurationType: 'IndustryType',
  },
  {
    id: 'muu_toimiala',
    displayValue: 'muu toimiala',
    order: 160,
    configurationType: 'IndustryType',
  },
];
